      ...
      <div className="mx-auto px-3.5 w-full">
        <div className="flex">
          <div className="w-full flex justify-between">
            ...
            <div className="text-gray-600 text-sm leading-6 flex space-x-6">
              <Link className="flex items-center gap-2" to={helpContacts.phone.link}>
              ...
              <Link className="flex items-center gap-2" to={helpContacts.whatsappPhone.link}>
                <WhatsappIcon className="text-[#8E8E93] w-7.5 h-7.5" />
                <span>{helpContacts.whatsappPhone.text[lang]}</span>
              </Link>
              <Link className="flex items-center gap-2" to={helpContacts.whatsappAnonChat.link}>
                <WhatsappIcon className="text-[#8E8E93] w-7.5 h-7.5" />
